...
Suppose you have component which is rendered in the page that needs to fetch data
...
This approach will work however it is not the intended way this library it is supposed to be used. Instead, you should use `useQuery` which is designed to handle initial data fetching and re-fetching based on variable changes.
